    ...
    for (int r = 0; r < dim; r++)
        for (int c = 0; c < dim; c++)
        {
            ...
            for (int rr = 0; rr < dim; rr++)
            {
                ...
                {
                    const double entry_rr_cc =
                    dI1_dM(rr,cc)*dI1_dM(r,c) + I1*dI1_dMdM(rr,cc);
                    for (int i = 0; i < dof; i++)
                        for (int j = 0; j < dof; j++)
                        {
                            A(i+r*dof, j+rr*dof) +=
    ...
    for (int r = 0; r < dim; r++)
        for (int c = 0; c < dim; c++)
        {
            ...
            for (int rr = 0; rr < dim; rr++)
            {
                ...
                {
                    const double entry_rr_cc =
                    2.*dI2_dMdM(rr,cc)*(I2 - 1.) + 2.*dI2_dM(rr,cc)*dI2_dM(r,c);
    ...
    for (int r = 0; r < dim; r++)
        for (int c = 0; c < dim; c++)
        {
            ...
            for (int rr = 0; rr < dim; rr++)
            {
                ...
                {
                    const double entry_rr_cc =
                    2.*dI1_dM(rr,cc)*dI1_dM(r,c) + dI1_dMdM(rr,cc)*(2.*I1 - 2.);
